...
$Output=OpenWrite[FileNameJoin@{"outs", "out_script_old.txt"}]//Prepend[$Output, #]&; 
$Messages=OpenWrite[FileNameJoin@{"logs", "log_script_old.txt"}]//Prepend[$Messages, #]&; ; 
...
r1r2Pot=
  With[{H5FullVecPot=$H5OldVecPot, r1r2Grid=r1r2Grid},
    ParallelTable[
      {a, s,
        Min[
          H5FullVecPot@
